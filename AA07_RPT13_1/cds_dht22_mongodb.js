...
var portName = 'COM15';  // check your COM port!!
...
seconedcommadix =readData.indexOf(',',firstcommaidx+1) + 1 ; 
   ...
   garbage= readData.substring(firstcommaidx + 1, readData.indexOf(',',firstcommaidx+1));
        temp= readData.substring(readData.indexOf(',',firstcommaidx+1) + 1, readData.indexOf(',',seconedcommadix));
        humi = readData.substring(readData.indexOf(',',seconedcommadix)+1, readData.lastIndexOf(','));
